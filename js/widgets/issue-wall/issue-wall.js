    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        */
        _getRelatedTableInfo: function () {
            ...
            //console.log(operationalLayer.relationships);
                   ...
                   // console.log(r.features.length);
                    ...
                    for (var i = 0; i < ds.length; i++) {
                        ...
                        require(["dojo/dom-attr"], function (domAttr) {
                            ...
                            if (did == cid) {
                                d.innerHTML = r.features.length;
                            }
                        });
                    }
                }

                //if (relatedRecords[cid].features === undefined) {
                //    return "";
                //}
                //else {
                //    console(relatedRecords[cid].features);
                //    return relatedRecords[cid].features.length;
                //}
                //console.log(relatedRecords[cid]);
        ...
        _displayIssueList: function (featureSet, operationalLayer, flagObject, relatedTable) {
            ...
            if (this.operationalLayerDetails.popupInfo && featureSet.length > 0) {
                ...
                for (i = 0; i < featureSet.length; i++) {
                   ...
                   // var rid = this.operationalLayerDetails.layerObject.relationshipId;
                    var cid = featureSet[i].attributes["OBJECTID"];
                   // console.log(featureSet[i]);
                   var commentnum=this._countComments(cid,commentParams);
                  // console.log(commentnum + "---" + cid);
        ...
        */
        _showIssueDetails: function (parentDiv, featureSet, statusParamObj, issueTitleName, relatedTable) {
           ...
           // console.log(issueDetailsTemplateString);
                                ...
                                if (this.listContainer.children.length) {
                                    ...
                                    for (i = 0; i < this.listContainer.children.length; i++) {
                                        ...
                                        if (likeIconDiv) {
                                            ...
                                            //dojo.removeClass(likeIconDiv, "esriCTLikeIcon");
