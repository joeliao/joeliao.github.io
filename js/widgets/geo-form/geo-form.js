    ...
    return declare([_WidgetBase, _TemplatedMixin], {
        ...
        */
        _init: function () {
            ...
            //BootstrapMap.createWebMap("209c28e33e8741f48da4bd8850d2e7f5", "gf-mapDiv", {
                ignorePopups: true,
        ...
        */
        _filterLayerFields: function (response) {
            ...
            //modified by Xiongjiu on 3/19/2015
            excludeNames = ["VOTE", "Editor", "Creator", "EditDate", "CreationDate"];
                ...
                array.some(response.itemInfo.itemData.operationalLayers, lang.hitch(this, function (operationalLayer, index) {
                    ...
                    if (operationalLayer.id === this.layerId) {
                        ...
                        array.forEach(this.layer.fields, lang.hitch(this, function (layerField) {
                            //if (layerField.NAME == "PUBLICINUT" || layerField.NAME == "NAME" || layerField.NAME == "EMAIL" || layerField.NAME == "PHONE" )
                        ...
                        array.forEach(response.itemInfo.itemData.operationalLayers[index].popupInfo.fieldInfos, lang.hitch(this, function (popupField) {
                            ...
                            if (popupField.isEditable && $.inArray(layerField.type, excludeDataTypes) === -1 && $.inArray(layerField.name, excludeNames) === -1) {
