        ...
        */
        showHideCommentIcon: function (commentParams, issueDetailsParam) {
            ...
            if (commentParams.commentFlag && commentParams.relatedTable) {
                ...
                //add commentnumber icons
                commentCountIcon = query('.esriCTCommentCount', commentParams.parentNode)[0];
                domAttr.set(commentCountIcon, "objId", commentParams.attributes[commentParams.objectId]);
